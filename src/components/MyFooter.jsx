    ...
    <footer className="bg-[var(--color-primary)] text-white border-t-4 border-[var(--color-accent)] ">
      <div className="w-full container mx-auto p-8 ">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10">
          <div className="sm:col-span-2">
            <Link to="/" className="flex items-center mb-4">
              <span className="text-2xl font-semibold text-white">RRB Pet House</span>
            </Link>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300 text-sm">
              <li><a href="https://github.com/1ThomasShelby1" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">GitHub</a></li>
              <li><a href="https://www.linkedin.com/in/rutik-bhamare-2a8a29247/" target="_blank" rel="noopener noreferrer" className="hover:text-white transition">LinkedIn</a></li>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
          <p className="text-gray-300 text-sm">&copy; {new Date().getFullYear()} RRB Pet House™. All rights reserved.</p>

          <div className="flex space-x-5 text-white">
           
            <a href="https://www.linkedin.com/in/rutik-bhamare-2a8a29247/" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-accent)] transition">
              <FaLinkedin size={20} />
            </a>
            <a href="https://github.com/1ThomasShelby1" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-accent)] transition">
              <FaGithub size={20} />
            </a>
            <a href="https://wa.me/9552467716" target="_blank" rel="noopener noreferrer" className="hover:text-[var(--color-accent)] transition">
              <FaWhatsapp size={20} />
            </a>
