    ...
    <nav className="bg-[var(--color-primary)] shadow-lg sticky top-0 z-50 border-b-4 border-[var(--color-accent)]">
      <div className="container mx-auto px-4">
        <div className="px-4 flex justify-between items-center py-2">
          ...
          <h1 className="flex items-center space-x-3 font-bold text-2xl">
            <Link to="/" className="flex items-center space-x-3">
              <img src={logo} alt="RRB Pets Logo" className="h-12" />
              <span className="tracking-wide text-gray-800">RRB Pethouse</span>
            </Link>
          </h1>
      ...
      <div
        className={`md:hidden bg-[var(--color-primary)] shadow-lg transition-max-height duration-500 ease-in-out overflow-hidden ${isMobileMenuOpen ? 'max-h-screen' : 'max-h-0'
          }`}
      >
