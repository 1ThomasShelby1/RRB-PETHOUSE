    ...
    return (
        <div className="pt-16">
            <h2 className="text-4xl text-center font-extrabold text-gray-800 pb-2">
                RRB Pets Where Every Pet Finds a Family
            </h2>
                    ...
                    <div>
                        <Fade direction="right" cascade damping={0.1} triggerOnce>
                            ...
                            <p className="text-gray-600 mb-2 text-lg">
                                At RRB Pet House, we believe every pet deserves a chance at a happy, loving life. Our platform was created to bridge the gap between pets in need and compassionate individuals ready to open their hearts and homes.
                            </p>
