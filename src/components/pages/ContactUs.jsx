                        ...
                        <div className="space-y-8">
                            ...
                            <div className='flex items-center justify-center  '>
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">Nashik, Maharashtra</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4 py-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">hrutikbhamare10@gmail.com</p>
                                </div>
                            </div>
                            <div className="flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400">9552467716</p>
                                </div>
                                </div>
                                </div>
                            </div>
